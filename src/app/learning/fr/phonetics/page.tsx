        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-4">
            <Card className="w-full max-w-lg shadow-2xl">
                ...
                <CardContent className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-6">
                    <Link href="/learning/fr/phonetics/alphabet" passHref data-tutorial-id="phonetics-alphabet">
                    ...
                    <Link href="/learning/fr/phonetics/difficult-pronunciation" passHref className="col-span-1 sm:col-span-2" data-tutorial-id="phonetics-difficult">
                        <Button variant="outline" className="w-full h-28 flex-col gap-2 text-lg border-2 border-primary">
