...
import { Brain, CheckCircle, ShieldX, Clock } from 'lucide-react';
...
export default function DemoQuizResults({ onRestart }: DemoQuizResultsProps) {
            ...
            <CardFooter className="flex-col gap-4 pt-4">
                 <div className="flex w-full gap-4" data-tutorial-id="quiz-results-buttons">
                    ...
                    <Link href="/" passHref className="w-full">
                        <Button variant="outline" className="w-full" disabled={true}>{getUIText('backToMenu')}</Button>
                    </Link>
                </div>
                <Link href="/errors" passHref>
                    <Button variant="link" className="text-muted-foreground" disabled={true}>
