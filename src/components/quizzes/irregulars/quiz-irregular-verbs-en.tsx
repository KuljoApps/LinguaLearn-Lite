...
import { questions as initialQuestions, type IrregularVerbQuestion } from "@/lib/questions/irregulars/questions-irregular-verbs-en";
...
export default function QuizIrregularVerbsEn() {
