...
import { questions as initialQuestions, type IrregularVerbQuestion } from "@/lib/questions/irregulars/questions-irregular-verbs-es";
...
const QUIZ_NAME = 'Verbos Irregulares (ES)';
const TIME_UPDATE_INTERVAL = 5; // seconds
const QUIZ_LENGTH = 10;


export default function QuizIrregularVerbsEs() {
    ...
    <>
      <Card className="w-full max-w-lg shadow-2xl">
        <CardHeader className="text-center pb-4">
          ...
          <CardDescription className="pt-2">Selecciona la traducción y completa las formas verbales</CardDescription>
        </CardHeader>
          ...
          <div className="w-full space-y-4">
            ...
            {(answerStatus === 'incorrect' || (answerStatus === 'timeout' && (!form2Input || !form3Input))) && (
              <div className="text-center text-success font-medium animate-in fade-in">
                  Formas correctas: {currentQuestion.form2}, {currentQuestion.form3}
              </div>
            )}
