...
import { questions as initialQuestions, type Question } from "@/lib/questions/phrasals/questions-phrasal-verbs-en";
...
export default function QuizPhrasalVerbsEn() {
    ...
    <>
      <Card className="w-full max-w-lg shadow-2xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="pt-2">Select the correct translation for the phrasal verb</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center p-6 space-y-8">
          ...
          <div className="text-center space-y-2">
              <p className="text-muted-foreground">What is the Polish meaning of the phrasal verb</p>
              <p className={cn(
