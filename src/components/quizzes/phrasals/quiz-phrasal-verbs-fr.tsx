...
import { questions as initialQuestions, type Question } from "@/lib/questions/phrasals/questions-phrasal-verbs-fr";
    ...
    <>
      <Card className="w-full max-w-lg shadow-2xl">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="pt-2">Attention aux faux amis ! Choisissez la bonne traduction</CardDescription>
        </CardHeader>
