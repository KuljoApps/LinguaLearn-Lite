...
export const allAchievements: Achievement[] = [
  ...
  { id: 'novice', name: 'Novice', name_fr: 'Débutant', name_de: 'Anfänger', name_it: 'Novizio', name_es: 'Novato', description: 'Answer 50 questions correctly.', description_fr: 'Répondre correctement à 50 questions.', description_de: 'Beantworte 50 Fragen richtig.', description_it: 'Rispondi correttamente a 50 domande.', description_es: 'Responde 50 preguntas correctamente.', icon: Sparkles, goal: 50 },
  { id: 'apprentice', name: 'Apprentice', name_fr: 'Apprenti', name_de: 'Lehrling', name_it: 'Apprendista', name_es: 'Aprendiz', description: 'Answer 250 questions correctly.', description_fr: 'Répondre correctement à 250 questions.', description_de: 'Beantworte 250 Fragen richtig.', description_it: 'Rispondi correttamente a 250 domande.', description_es: 'Responde 250 preguntas correctamente.', icon: Star, goal: 250 },
  ...
  { id: 'mastery_phrasal_es', name: 'Preposition Pro (ES)', name_es: 'Profesional de Preposiciones (ES)', description: 'Correctly answer every prepositional verb question.', description_es: 'Responde correctamente a cada pregunta de verbos con preposición.', icon: Brain, goal: phrasalVerbsEsQuestions.length },
