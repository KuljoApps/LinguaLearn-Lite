...
export const allAchievements: Achievement[] = [
  ...
  { id: 'mastery_phrasal_es', name: 'False Friends Fanatic (ES)', name_es: 'Experto en Falsos Amigos', description: 'Correctly answer every false friend question.', description_es: 'Responde correctamente a cada pregunta sobre falsos amigos.', icon: Brain, goal: phrasalVerbsEsQuestions.length },
